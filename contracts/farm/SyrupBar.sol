...
contract SyrupBar is ERC20("YumiSwapBar Token", "SYRUP") {
    ...
    constructor(YumiToken _cake) public {
        cake = _cake;
    }

    // Safe cake transfer function, just in case if rounding error causes pool to not have enough YUMIs.
